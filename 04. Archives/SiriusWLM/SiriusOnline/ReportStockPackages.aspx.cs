...
{
    public partial class ReportStockPackages : System.Web.UI.Page
    {
        ...
        protected void ButtonExecute_Click(object sender, EventArgs e)
        {
            ...
            {
                LiteralReport.Text = EntityModels.Reports.ReportStockPackages.ToHTML(Master.Model, new EntityModels.Reports.ReportStockPackagesFilterCriteria { ClientId = Master.LoggedClientUser.Client.Id, DateExecution = dateExecution }, false);
            }
            else
            {
