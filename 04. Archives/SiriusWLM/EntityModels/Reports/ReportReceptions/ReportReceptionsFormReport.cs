...
{
    public partial class ReportReceptionsFormReport : CustomControls.EntityFormReport
    {
        private EntityModelSirius Model;
        public ReportReceptionsFilterCriteria Criteria;

        public ReportReceptionsFormReport()
        {
            InitializeComponent();
        ...
        {
            SaveFieldsToFilter();
            webBrowser.DocumentText = ReportReceptions.ToHTML(Model, Criteria);
            base.RefreshReport();
        }
        ...
        {
            base.ShowForm();
            SetFormName(ReportReceptions.Name);
            RefreshReport();
        }
