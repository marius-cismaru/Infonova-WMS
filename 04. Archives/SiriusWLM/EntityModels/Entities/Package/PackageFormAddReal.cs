...
{
    public partial class PackageFormAddReal : CustomControls.EntityFormEdit
    {
        ...
        public override void FormEdit_Shown(object sender, EventArgs e)
        {
            ...
            ReceptionSelected = Receptions.ReceptionCollection.GetById(Model, ReceptionId, false);
            if (ReceptionSelected == null)
            {
                MessageBox.Show("Receptie nedefinita.", "EROARE", MessageBoxButtons.OK, MessageBoxIcon.Error);
                Close();
            }
            Entity.Reception = ReceptionSelected;
        ...
        public override void LoadFieldsFromEntity()
        {
            ...
            PackagePrevious = Packages.PackageCollection.GetById(Model, PackagePreviousId, false);
            if (PackagePrevious != null)
            {
                Entity.Batch = PackagePrevious.Batch;
                Entity.Description = PackagePrevious.Description;
                Entity.DateExpiration = PackagePrevious.DateExpiration;
                Entity.DateProduction = PackagePrevious.DateProduction;
                Entity.PackageType = PackagePrevious.PackageType;
                Entity.Product = PackagePrevious.Product;
            }

            ReceptionOrderProducts.ReceptionOrderProductCollection.PopulateSelectBox(ReceptionSelected.ReceptionOrderProducts.ToList(), selectBoxProduct, Entity.Product != null ? Entity.Product.Id : 0);
        ...
        public override bool SaveFieldsToEntity()
        {
            ...
            else
            {
                ...
                {
                    bool warehouseContainerAvailable = WarehouseContainers.WarehouseContainerCollection.CheckIfAvailableById(WarehouseContainerSelected.Id);
                ...
                if (validationOK)
                {
                    ...
                    Entity.ContainerInitial = WarehouseContainerSelected.Name;
                    ...
                    Model.Packages.AddObject(Entity);
                    Model.SaveChanges();
        ...
        private void selectBoxProduct_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ProductSelected != null)
            {
                ...
                textBoxCode.Text = Packages.PackageCollection.GenerateNewCode(Entity.Reception.Client.NameSymbol1, Entity.Reception.Number, Model.ReceptionOrderProducts.Where(o => o.Reception.Id == ReceptionId).ToList().FindIndex(o => o.Product.Id == ProductSelected.Id), Model.Packages.Count(o => o.Reception.Id == ReceptionId && o.Product.Id == ProductSelected.Id) + 1);
            }
        }
        ...
        {
            List<int> warehouseContainerIdList = WarehouseContainers.WarehouseContainerCollection.Select(ReceptionSelected.Warehouse.Id, 1);
